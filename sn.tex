...
therefore a key design point of the SN survey.
...
\subsection{Light curve quality}
...
\subsection{Size and redshift extent of the SN sample}
...
The quality assessment the DDF supernova sample was performed
classically using a Monte-Carlo method. 
